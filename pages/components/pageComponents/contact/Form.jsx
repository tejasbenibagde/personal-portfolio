          ...
          return (
            <React.Fragment key={index}>
              ...
              <div className="flex gap-[2vw] lg:gap-[5vw]">
                <h1 className="text-[var(--white)] opacity-[0.5] font-[400] text-[3vw] md:text-[2vw] lg:text-[1.5vw] xl:text-[1.2vw] 2xl:text-[0.8vw] w-5">
                  {count}
                </h1>
                <div className="flex flex-col gap-[3vh]">
                  <h1 className="text-[var(--white)] text-[4vw] md:text-[3vw]">
                    {question}
                  </h1>
                  <input
                    type={type}
                    ...
                    className="bg-[var(--black)] text-[3vw] md:text-[2vw] lg:text-[1.4vw] xl:text-[1.2vw] 2xl:text-[1vw] outline-none text-[var(--white)] w-full"
                  />
                </div>
              </div>
            </React.Fragment>
        ...
        <div className="flex gap-[2vw] lg:gap-[5vw]">
          ...
          <div className="flex flex-col gap-[3vh]">
            ...
            <textarea
              ...
              onChange={postUserData}
              autoComplete="off"
              placeholder="Hello Tejas, can you help me with ... *"
              className="bg-[var(--black)] text-[3vw] md:text-[2vw] lg:text-[1.4vw] xl:text-[1.2vw] 2xl:text-[1vw] outline-none text-[var(--white)] w-[calc(80vw)] max-w-[80vw] h-auto"
            />
          </div>
        </div>
            ...
            <Magnet>
              <Rounded cursor={true}>
                {loader ? (
                  ...
                  <button
                    type="submit"
                    className="text-[var(--black)] w-full h-full text-[4vw] md:text-[2.5vw] lg:text-[2vw] xl:text-[1.5vw] 2xl:text-[1vw] "
                  >
                    Send it!
                  </button>
                )}
