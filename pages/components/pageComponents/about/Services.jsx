    ...
    return (
        <>
            <div ref={container} className="lg:flex lg:justify-between">
                <m.div style={{ y: width >= 1024 ? y : 0 }} className='flex lg:mt-[10vh] flex-col gap-[4vh] md:px-[5vw] lg:w-[35vw] lg:gap-[2vw]'>
                ...
                <div className='relative mt-[5vh] py-[10vh] lg:h-[65vw] w-full lg:w-[55vw] lg:mt-0'>
                    <Image
                        src={profile}
                        alt='profile'
            ...
            <div className='relative md:mt-[10vh] lg:mt-[15vh] xl:mt-[20vh]'>
