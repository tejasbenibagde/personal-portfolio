  ...
  const project = [
    {
      ...
      title: "King's Gambit",
      url: "https://king-gambit.netlify.app/",
        ...
        {project.map((project, index) => {
          ...
          return (
            <div
              ...
              className="cursor-pointer w-[100%] md:w-[42.5vw]"
            >
              <div
                style={{ backgroundColor: color }}
                className="w-[100%] md:h-[40vw] md:w-[42.5vw] h-[90vw] px-[5vw] flex items-center justify-center "
              >
                <Image
                  src={src}
                  alt="weather"
              ...
              <h2 className="text-[8vw] md:text-[4vw] font-[500] my-3">
                {title}
              </h2>
              <div className="hbar" />
              <div className="flex justify-between mt-3 mb-[10vh]">
                <p className="text-[4vw] md:text-[2vw] font-[400]">
                  {attribute}
                </p>
