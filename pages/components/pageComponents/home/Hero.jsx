...
function Hero() {
  ...
  return (
    <div className="hero-section" ref={container}>
      ...
      <m.div
        style={width > 768 ? { y: y } : null}
        className="absolute top-[50vh] md:top-[75vh] lg:top-[70vh] left-0"
      >
        <m.div
          ref={slider}
          className="flex relative whitespace-nowrap"
      ...
      <m.div
        style={width > 768 ? { y: y } : null}
        className="absolute w-[90vw] top-[87vh] md:top-[50vh] flex px-[5vw] md:justify-end"
      >
        <div>
          <svg
          ...
          <h2 className="text-[var(--white)] text-[5.5vw] md:text-[4vw] lg:text-[2.5vw] xl:text-[2.2vw] 2xl:text-[2vw]">
            Full stack <br />
            web developer
          </h2>
        </div>
